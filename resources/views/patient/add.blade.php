...
@section('content')
    <div class="w-full p-6 bg-white shadow-md">
        ...
        <form method="POST" action="{{ route('patients.store') }}" class="space-y-6">
            ...
            <div>
                <label for="year_course_dept" class="block text-sm font-medium text-gray-700">Year, Course,
                    Department</label>
                <input type="text" id="year_course_dept" name="year_course_dept"
                    class="mt-1 w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            ...
            <div>
                <button type="submit"
                    class="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Submit
                </button>
            </div>
        </form>
