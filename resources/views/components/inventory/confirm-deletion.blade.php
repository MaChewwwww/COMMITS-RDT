        ...
        <div class="relative bg-white rounded-lg shadow-xl border-l-4 border-red-500">
            ...
            <div class="p-6">
                <div class="flex flex-col items-center text-center">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-16 h-16 mb-4 text-red-500 bg-red-100 rounded-full">
                    ...
                    <h3 class="mb-5 text-lg font-medium text-gray-800">Are you sure you want to delete this record?</h3>
