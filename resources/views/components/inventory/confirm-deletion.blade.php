...
<div id="{{ $target }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 bg-black/50 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full">
