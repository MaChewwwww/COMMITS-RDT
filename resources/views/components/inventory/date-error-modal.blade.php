<div id="date-error-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 h-screen left-0 right-0 z-50 nt-0 hidden w-full h-full overflow-x-hidden overflow-y-auto flex items-center justify-center" style="background-color: rgba(0, 0, 0, 0.5); backdrop-filter: blur(4px);">
