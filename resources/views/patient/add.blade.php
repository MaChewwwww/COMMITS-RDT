    ...
    <body>
        ...
        <form method="POST" action="{{ route('patients.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="fullname" name="fullname" class="mt-1 p-2 border rounded" required>
            </div>

            <!-- Sex -->
            <div class="mb-4">
                <label for="sex" class="block text-sm font-medium text-gray-700">Sex</label>
                <select id="sex" name="sex" class="mt-1 p-2 border rounded" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="year_course_dept" name="year_course_dept" class="mt-1 p-2 border rounded" required>
            </div>

            <!-- Contact Details -->
            <div class="mb-4">
                <label for="contactDetails" class="block text-sm font-medium text-gray-700">Contact Details</label>
                <input type="text" id="contactDetails" name="contactDetails" class="mt-1 p-2 border rounded" required>
            </div>

            <!-- Patient Status -->
            <div class="mb-4">
                <label for="patient_status" class="block text-sm font-medium text-gray-700">Patient Status</label>
                <input type="text" id="patient_status" name="patient_status" class="mt-1 p-2 border rounded" required>
            </div>

            <!-- Patient Type -->
            <div class="mb-4">
                <label for="patientType" class="block text-sm font-medium text-gray-700">Patient Type</label>
                <select id="patientType" name="patientType" class="mt-1 p-2 border rounded" required>
            ...
            <!-- Student Number (Initially disabled) -->
            <div class="mb-4">
                <label for="student_number" class="block text-sm font-medium text-gray-700">Student Number</label>
                <input type="text" id="student_number" name="student_number" class="mt-1 p-2 border rounded" disabled>
            </div>

            <!-- User ID (Optional) -->
            <div class="mb-4">
                <label for="user_id" class="block text-sm font-medium text-gray-700">User ID</label>
                <input type="number" id="user_id" name="user_id" class="mt-1 p-2 border rounded">
            </div>
