    ...
    <div class="p-4 m-4">
        ...
        <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="space-y-4">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="fullname" id="fullname" value="{{ old('fullname', $patient->fullname) }}"
                    class="border border-gray-300 p-2 rounded-md @error('fullname') border-red-500 @enderror">
                @error('fullname')
            ...
            <div class="flex flex-col">
                ...
                <select name="sex" id="sex"
                    class="border border-gray-300 p-2 rounded-md @error('sex') border-red-500 @enderror">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="year_course_dept" id="year_course_dept"
                    value="{{ old('year_course_dept', $patient->year_course_dept) }}"
                    class="border border-gray-300 p-2 rounded-md @error('year_course_dept') border-red-500 @enderror">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="contactDetails" id="contactDetails"
                    value="{{ old('contactDetails', $patient->contactDetails) }}"
                    class="border border-gray-300 p-2 rounded-md @error('contactDetails') border-red-500 @enderror">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="patient_status" id="patient_status"
                    value="{{ old('patient_status', $patient->patient_status) }}"
                    class="border border-gray-300 p-2 rounded-md @error('patient_status') border-red-500 @enderror">
            ...
            <div class="flex flex-col">
                ...
                <select name="patientType" id="patientType"
                    class="border border-gray-300 p-2 rounded-md @error('patientType') border-red-500 @enderror">
                    <option value="Student" {{ old('patientType', $patient->patientType) == 'Student' ? 'selected' : '' }}>
                        Student</option>
                    <option value="Faculty" {{ old('patientType', $patient->patientType) == 'Faculty' ? 'selected' : '' }}>
                        Faculty</option>
                    <option value="Admin" {{ old('patientType', $patient->patientType) == 'Admin' ? 'selected' : '' }}>
                        Admin</option>
                    <option value="Visitor" {{ old('patientType', $patient->patientType) == 'Visitor' ? 'selected' : '' }}>
                        Visitor</option>
                    <option value="Dependent"
                        {{ old('patientType', $patient->patientType) == 'Dependent' ? 'selected' : '' }}>Dependent</option>
                </select>
                @error('patientType')
                    <p class="text-sm text-red-500">{{ $message }}</p>
                @enderror
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="student_number" name="student_number" class="p-2 mt-1 border rounded"
            ...
            <div class="flex flex-col">
                ...
                <input type="number" name="user_id" id="user_id" value="{{ old('user_id', $patient->user_id) }}"
                    class="border border-gray-300 p-2 rounded-md @error('user_id') border-red-500 @enderror">
                @error('user_id')
                    <p class="text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-6 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600">Update
                    Patient</button>
            </div>
        </form>
    </div>
