    ...
    <div class="container flex flex-col mx-auto">
        ...
        <div class="relative space-y-4">
            <div class="flex flex-col gap-4 sm:gap-8 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button data-modal-target="create-{{ Route::currentRouteName() }}" data-modal-toggle="create-{{ Route::currentRouteName() }}" class="self-center h-12 px-4 py-2 text-lg font-medium text-center text-white transition-all bg-blue-500 border border-transparent rounded-lg shadow-md sm:self-end w-28 hover:shadow-lg focus:bg-blue-700 focus:shadow-none active:bg-blue-600 hover:bg-blue-600 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
