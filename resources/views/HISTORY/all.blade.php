                ...
                <div class="flex space-x-4">
                    ...
                    <div class="relative inline-block text-left">
                        <button onclick="toggleDropdown('month-dropdown')"
                            class="bg-yellow-400 text-white px-4 py-2 rounded-md hover:bg-yellow-500 flex items-center">
                    ...
                    <div class="relative inline-block text-left">
                        <button onclick="toggleDropdown('week-dropdown')"
                            class="bg-red-900 text-white px-4 py-2 rounded-md hover:bg-red-1000 flex items-center">
                            ...
                            <ul class="py-1">
                                ...
                                @foreach ($weeks as $week)
                                    <li><a href="{{ route('History.all', ['week' => $week]) }}"
                                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Week
                                            {{ $week }}</a></li>
                                @endforeach
                            </ul>
                        </div>
