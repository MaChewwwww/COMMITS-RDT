...
@section('content')
    ...
    <div class="flex flex-row justify-end pb-6 pr-16 text-white gap-x-5">
        <button title="Edit" onclick=openModal() class="px-4 py-2 bg-red-800 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
              </svg>              
        </button>
        <button title="Print" onclick=printDiv() class="px-4 py-2 bg-red-800 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
    ...
    <div id="editReportModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-gray-900 bg-opacity-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-[80vh] max-w-auto max-w-4xl mx-4 sm:mx-auto overflow-y-auto max-h-[80vh] relative"> 
            ...
            <form id="editReportForm" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter title">
                </div>
                <div>
                    <div class="flex flex-row gap-x-1">
                        <label for="physicianName" class="block text-sm font-semibold">Name of physician</label><span class="text-red-500">*</span>
                    </div>
                    <input type="text" id="physicianName" name="physicianName" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter name">
                </div>
                <div>
                    <div class="flex flex-row gap-x-1">
                        <label for="position" class="block text-sm font-semibold">Position</label><span class="text-red-500">*</span>
                    </div>
                    <input type="text" id="position" name="position" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter position">
                </div>
                <div>
                    <div class="flex flex-row gap-x-1">
                        <label for="unitDepartment" class="block text-sm font-semibold">Unit / Department</label><span class="text-red-500">*</span>
                    </div>
                    <input type="text" id="unitDepartment" name="unitDepartment" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter title">
                </div>
                <div>
                    <div class="flex flex-row gap-x-1">
                        <label for="campusPhysician" class="block text-sm font-semibold">Campus physician</label><span class="text-red-500">*</span>
                    </div>
                    <input type="text" id="campusPhysician" name="campusPhysician" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter name">
                </div>
                <div>
                    <div class="flex flex-row gap-x-1">
                        <label for="campusNurse" class="block text-sm font-semibold">Campus nurse</label><span class="text-red-500">*</span>
                    </div>
                    <input type="text" id="campusNurse" name="campusNurse" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter name">
                </div>
                <div class="flex flex-col sm:w-1/2">
                    ...
                    <div class="flex flex-row gap-x-5">
                        ...
                        <input type="datetime-local" id="fromDurationDate" name="fromDurationDate" class="p-2 text-sm border rounded-md w-52" required>
                        </div>
                        <div class="flex flex-col">
                            <label for="toDurationDate" class="block text-sm font-semibold">To</label>
                            <input type="datetime-local" id="toDurationDate" name="toDurationDate" class="p-2 text-sm border rounded-md w-52 " required>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/2">
                    ...
                    <input type="datetime-local" id="submissionDate" name="submissionDate" class="p-2 text-sm border rounded-md w-52" required>
                </div>
                {{-- Control number --}}
                <div class="space-y-4 w-fulls">
                    <div class="flex flex-col">
                        <div class="flex flex-row gap-x-1">
                            <label for="controlNumber" class="block text-sm font-semibold">Control number</label><span class="text-red-500">*</span>
                        </div>
                        <input type="text" id="controlNumber" name="controlNumber" class="w-full p-2 text-sm border rounded-md" required placeholder="Enter control number">
                    </div>
                    <div class="flex flex-row gap-x-5">
                        <div class="flex flex-col">
                            <div class="flex flex-row gap-x-1">
                                <label for="controlNumberDate" class="block text-sm font-semibold">Control number date</label><span class="text-red-500">*</span>
                            </div>
                            <input type="datetime-local" id="controlNumberDate" name="controlNumberDate" class="p-2 text-sm border rounded-md w-52" required>
                        </div>
                        <div class="flex flex-col">
                            <div class="flex flex-row gap-x-1">
                                <label for="controlNumberRevision" class="block text-sm font-semibold">Revision</label><span class="text-red-500">*</span>
                            </div>
                            <input type="number" id="controlNumberRevision" name="controlNumberRevision" class="p-2 text-sm border rounded-md w-52" required placeholder="Enter revision number">
                        </div>
                    </div>
                </div>
                {{-- Action buttons --}}
